...
public class KafkaTbCoreQueueFactory implements TbCoreQueueFactory {
    ...
    @Override
    public TbQueueProducer<TbProtoQueueMsg<ToReplicaMsg>> createReplicaMsgProducer() {
        TbKafkaProducerTemplate.TbKafkaProducerTemplateBuilder<TbProtoQueueMsg<ToReplicaMsg>> requestBuilder = TbKafkaProducerTemplate.builder();
        requestBuilder.settings(kafkaSettings);
